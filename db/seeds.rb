...
project_2 = Project.create!(title: "Go Blue!", date: "2019-05-30", organizer: user_2, description: "Plant things.", active: true, image: 'https://picsum.photos/id/1015/400/300')
address_51 = Address.create!(owner: project_2, line_1: "By the trailhead", line_2: "Off I-70", city: "Frisco", state: "CO", zip: "80206")

project_3 = Project.create!(title: "Go Red!", date: "2019-05-30", organizer: user_2, description: "Plant things.", active: true, image: 'https://picsum.photos/id/1016/400/300')
address_61 = Address.create!(owner: project_3, line_1: "Not At the trailhead", line_2: "Off I-70", city: "Frisco", state: "CO", zip: "80206")

project_4 = Project.create!(title: "Go Brown!", date: "2019-05-30", organizer: user_2, description: "Plant things.", active: false, image: 'https://picsum.photos/id/1028/400/300')
